...
from utils.utils import RayQueueManager, QueueWorker
...
def rank_by_subset_df(subsets_file_path: str, prop_res_file: str, output_dir: str, num_workers=cpu_count()) -> None:
    # rand_seed(1042)
    init_ray(address=None, ignore_reinit_error=True)  # configuration for docker to avoid crush on dashboard launch
